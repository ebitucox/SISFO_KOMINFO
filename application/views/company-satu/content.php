				...
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						foreach ($bannerhome->result_array() as $ban2) {
							if ($no == 0) {
						?>
								<div class="item active"><a href="http://localhost/sisfo_kominfo/" target="_blank"><img src="asset/foto_iklantengah/smart2.jpg ?>" alt="smartcity kota makssar" caption="false" width="1288" height="627" /></a></div>
							<?php
							} else {
							?>
								<div class="item "><a href="http://localhost/sisfo_kominfo/" target="_blank"><img src="asset/foto_iklantengah/card2.jpg" alt="kartu smart city makassar" caption="false" width="1288" height="627" /></a></div>
						<?php
							}
							$no++;
						}
